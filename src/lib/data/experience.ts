...
export const experience: Experience[] = [
	...
	},
	{
		...
		points: [
			'2026: automating the localization workflow, with CI that catches missing and stale translations across 21 languages before a maintainer ever sees the PR.',
	...
	{
		slug: 'crux',
		org: 'cruX, the programming club at BITS Hyderabad',
		role: 'Core member',
